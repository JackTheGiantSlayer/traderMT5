...
class BotSettings(Base):
    ...
    adx_len = Column(Integer, default=14, nullable=True)
    adx_threshold = Column(Integer, default=20, nullable=True)
    adx_mode = Column(String(20), default="cross_rising", nullable=True)
